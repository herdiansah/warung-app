...
*Status: Completed*
- [x] TASK-M2-1: Add web app manifest & service worker (cache app shell)
- [x] TASK-M2-2: Offline checkout intents in IndexedDB (idempotency key)
- [x] TASK-M2-3: Server-side idempotency handling
